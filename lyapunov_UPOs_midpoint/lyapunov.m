...
function [Lepx, Texp] = lyapunov(Integrator, M,Initial_time, Final_time, dt, Iteration , Discard_time, ic)
...
while (T2<Final_time)       % Iterate till the given Final Time
    ...
    X = midpoint(Integrator, T1,dt, T2, IC, M, F); % solve the extended system in an Iteration time-span
