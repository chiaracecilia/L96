...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tend = 1000*T; % Final time. How many times do I turn around the period?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% distribution istantaneus Lyap expo

j = 1; % exponent that I am considering 
